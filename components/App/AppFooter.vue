<template>
  <footer class="bg-gray-50 pt-5" v-if="!isDocs">
    <div
      class="container px-6 py-8 max-w-screen-lg w-full mx-auto flex flex-col debug-screens"
    >
      <div class="flex flex-col md:flex-row justify-between pb-3 pr-3">
          ...
          <div class="flex flex-row justify-start py-3">
            ...
            >
              <svg
                ...
                stroke-width="2"
                class="text-gray-400 hover:text-accent dark:text-gray-200 dark:hover:text-accent w-7 h-7 transition-all"
                viewBox="0 0 24 24"
              >
                <path
        ...
        >
          ...
          <div class="flex flex-col font-inter">
            ...
            <ul>
              <li class="footer-item">
                <NuxtLink to="/sodaforsparc"> SODA for SPARC </NuxtLink>
              </li>
              <li class="footer-item">
                <NuxtLink to="/sodaforcovid">
                  SODA for Covid-19 Research
                </NuxtLink>
              </li>
              <li class="footer-item">
                <NuxtLink to="/knowmore"> KnowMore </NuxtLink>
              </li>
              <li class="footer-item">
                <NuxtLink to="/sparclink"> SPARClink </NuxtLink>
              </li>
              <li class="footer-item">
                <NuxtLink to="/aqua"> AQUA </NuxtLink>
              </li>
            </ul>
          </div>
        </div>
