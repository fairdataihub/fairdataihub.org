<template>
  <footer class="bg-gray-50 pt-5" v-if="!isDocs">
    <div
      class="container px-6 py-8 max-w-screen-xl w-full mx-auto flex flex-col debug-screens"
    >
      <div class="flex flex-col md:flex-row justify-between pb-3 pr-3">
        <div class="w-full md:w-3/12 flex flex-col">
          ...
          <p class="text-gray-600 font-inter py-3">
          ...
          <div class="flex flex-row justify-start py-3">
            ...
            >
              <svg
                ...
                stroke-width="2"
                class="text-gray-400 hover:text-accent dark:text-gray-200 dark:hover:text-accent w-7 h-7"
                viewBox="0 0 24 24"
              >
                <path
            ...
            >
              <svg
                ...
                stroke-linejoin="round"
                stroke-width="0"
                class="text-gray-400 hover:text-accent dark:text-gray-200 dark:hover:text-accentw-7 h-7"
                viewBox="0 0 24 24"
              >
                <path
                  stroke="none"
        ...
        <div class="w-full md:w-8/12 grid grid-cols-2 md:grid-cols-3 gap-6">
          <div class="flex flex-col font-inter text-gray-600">
            <h3 class="footer-header">Products</h3>
            <ul>
              <li class="footer-item">SODA for SPARC</li>
              <li class="footer-item">SODA for Covid-19 Research</li>
              <li class="footer-item">KnowMore</li>
              <li class="footer-item">SPARClink</li>
              <li class="footer-item">AQUA</li>
            </ul>
          </div>
...
.footer-header {
  @apply uppercase text-gray-800 pb-3 font-semibold;
}
.footer-item {
  @apply text-gray-600 hover:text-gray-800 cursor-pointer pb-2;
}
</style>
