  ...
  <div class="flex flex-col justify-center items-center">
    <section class="max-w-screen-2xl mx-auto py-5 relative">
      ...
      >
        ...
        >
          <h1
            class="font-black text-3xl sm:text-4xl w-full mb-1 text-center dark:text-gray-50"
          >
            SODA for SPARC
          </h1>
          <h2
            class="w-full sm:text-2xl text-2xl mb-2 font-medium dark:text-gray-50 text-center"
          >
            Keep Calm and Curate!
          </h2>
          <p
            class="mb-8 leading-relaxed text-center text-base w-full font-asap text-black dark:text-white"
          >
          ...
          <div class="w-full flex justify-center">
            ...
            <NuxtLink to="/sodaforsparc/docs/getting-started/User-Interface">
              <button
                class="sm:ml-4 py-2 px-6 focus:outline-none rounded text-lg transition-all bg-black dark:bg-pink-600 text-white ring-2 ring-offset-2 ring-transparent dark:ring-offset-transparent hover:ring-pink-600 dark:hover:ring-offset-1 dark:hover:ring-white focus:ring-pink-600"
              >
                Explore the docs
              </button>
            </NuxtLink>
