<template>
  <base-section class="">
    ...
    >
      ...
      <p class="subheading">Version 1.0</p>
      ...
      <p>
        ...
        other operating rules, policies (including, without limitation, Fair
        Data Innovations Hub's Privacy Policy) and procedures that may be
        published from time to time on this Site by Fair Data Innovations Hub
      ...
      <h2 class="heading">Access to the Site</h2>

      <h3 class="subheading">Subject to these Terms</h3>
      ...
      <h3 class="subheading">Certain Restrictions</h3>
      ...
      <div class="pl-8">
        ...
        >
          <li>
            ...
            or otherwise commercially exploit the Site.
          </li>
          <li>
            You shall not change, make derivative works of, disassemble, reverse
      ...
      <h3 class="subheading">No Support or Maintenance</h3>
      ...
      <p>
        ...
        Fair Data Innovations Hub or its suppliers. Note that these Terms and
      ...
      <h2 class="heading">Third-Party Links & Ads; Other Users</h2>

      <h3 class="subheading">Third-Party Links & Ads</h3>
      ...
      <h3 class="subheading">Other Users</h3>
      ...
      <h3 class="subheading">Cookies and Web Beacons</h3>

      <p>
        Like any other website, Fair Data Innovations Hub uses ‘cookies’. These
      ...
      <h2 class="heading">Limitation on Liability</h2>
      ...
      <h3 class="subheading">Term and Termination</h3>
      ...
      <p>
        ...
        termination of your rights under these Terms, your Account and right to
        access and use the Site will terminate immediately. You understand that
        any termination of your Account may involve deletion of your User
      ...
      <h2 class="heading">Copyright Policy.</h2>
      ...
      <h3 class="subheading">Applicability of Arbitration Agreement</h3>
      ...
      <h3 class="subheading">Arbitration Rules</h3>
      ...
      <h3 class="subheading">Time Limits</h3>
      ...
      <h3 class="subheading">Authority of Arbitrator</h3>
      ...
      <p>
        ...
        more limited, more efficient and less expensive than rules applicable in
      ...
      <h3 class="subheading">Waiver of Class or Consolidated Actions</h3>
      ...
      <h3 class="subheading">Right to Waive</h3>
      ...
      <h3 class="subheading">Small Claims Court</h3>
      ...
      <h3 class="subheading">Emergency Equitable Relief</h3>

      <p>
        Anyhow the foregoing, either party may seek emergency equitable relief
        before a state or federal court in order to maintain the status quo
        pending arbitration. A request for interim measures shall not be deemed
        a waiver of any other rights or obligations under this Arbitration
        Agreement.
      </p>

      <h3 class="subheading">Claims Not Subject to Arbitration</h3>
      ...
      <h3 class="subheading">Electronic Communications</h3>
      ...
      <h3 class="subheading">Entire Terms</h3>
      ...
      <h3 class="subheading">Copyright/Trademark Information</h3>
