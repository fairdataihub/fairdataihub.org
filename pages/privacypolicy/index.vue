<template>
  <base-section class="">
    ...
    >
      ...
      <h2 class="subheading">Information we collect</h2>
      ...
      <h2 class="subheading">How we use your information</h2>
      ...
      <h2 class="subheading">Cookies and Web Beacons</h2>
      ...
      <h2 class="subheading">Advertising Partners Privacy Policies</h2>
      ...
      <p>
        ...
        advertisements and links that appear on Fair Data Innovations Hub, which
      ...
      <h2 class="subheading">Third Party Privacy Policies</h2>

      <p>
        Fair Data Innovations Hub's Privacy Policy does not apply to other
      ...
      <h2 class="subheading">Children's Information</h2>
