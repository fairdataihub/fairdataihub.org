<template>
  <div>
    <Html>
      <Head>
        <Title>
          How to structure the subjects metadata file - SODA for SPARC
        </Title>
      </Head>
    </Html>
    ...
    <div class="flex flex-col">
      ...
      <ul class="list-disc list-outside docs-ul">
        <li>
          Format: The subjects file is accepted in either xlsx, csv, or json
          format. SODA generates it in the xlsx format based on the template
          provided by the Curation Team.
        </li>

        <li>
          Location in the dataset: The subjects file is typically expected in
          the high-level dataset folder.
        </li>

        <li>
          Content: The subject_id is mandatory (highlighted in bold and italic
          below) for all datasets and must be provided with one "Value". The
          other "experimental setup" elements (highlighted in bold-only below)
