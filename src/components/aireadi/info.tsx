              ...
              <div className="flex w-full flex-col justify-between sm:flex-row">
                <div className="mb-10 pr-10 sm:mb-5">
                  <p className="w-full font-asap text-lg text-black">
                    All software and tools from the AI-READI project, including
          ...
          <div className="mx-auto flex max-w-screen-lg flex-col">
            ...
            <div className="w-full py-2">
              <div className="flex w-full flex-col justify-between sm:flex-row">
                <div className="mb-10 pr-10 sm:mb-5">
                  <p className="w-full font-asap text-lg text-black">
                    The AI-READI project is lead by multiple institutions. In
                    addition to the FAIR Data Innovations Hub, other
