    ...
    >
      {heroImage ? (
        <div className="relative aspect-[16/9] w-full overflow-hidden">
          ...
          />
          {/* Soft overlay for text legibility consistency */}
      ...
      <div className="p-5 sm:p-6">
        ...
        <Link href={`/events/${slug}`}>
          <motion.h2
            ...
            className="group-hover:text-primary text-2xl leading-tight font-bold text-balance text-slate-900 underline-offset-4 group-hover:underline sm:text-3xl"
          >
            {title}
          </motion.h2>
        </Link>
        ...
        <div className="mt-4">
          <Link
            href={`/events/${slug}`}
            className="group-hover:text-primary text-sm font-medium underline-offset-4 hover:underline"
          >
