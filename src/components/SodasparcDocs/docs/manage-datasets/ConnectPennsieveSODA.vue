  ...
  <div class="flex flex-col">
    ...
    <div class="p-parent-div">
      ...
      <p>
        ...
        you should be all set. If an account is not found you can use your
        Pennsieve login details and allow SODA to retrieve the necessary
        information to connect to your Pennsieve account.
      </p>
    </div>
