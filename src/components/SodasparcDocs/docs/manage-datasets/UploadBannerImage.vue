  ...
  <div class="flex flex-col">
    ...
    <div class="p-parent-div">
      <p>
        ...
        you to easily add a banner image to your dataset. This image will be
        associated with the dataset and used as a thumbnail once the dataset is
        published.
      </p>
    </div>
    ...
    <ul class="docs-ul list-outside list-decimal">
      ...
      <li>
        ...
        have a minimum display size of 512x512 px (1024x1024 px preferred), and
        have a maximum file size of 5 MB.
      </li>
