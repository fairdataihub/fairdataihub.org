<template>
  ...
  <div class="flex flex-col">
    <base-docs-subtitle> Download and Open the Application </base-docs-subtitle>
    ...
    <div v-if="current_os === 'windows' || current_os === 'all'">
      ...
      <ul class="docs-ul list-outside list-decimal">
        ...
        <li>
          ...
          either running the desktop shortcut, searching for "SODA" on the start
          menu, or from the installation folder.
        </li>
        <li>
    ...
    <div v-if="current_os === 'macOS' || current_os === 'all'">
      ...
      <div class="p-parent-div">
        <p>
          The downloaded installer could be deleted since it is not necessary to
          run SODA. To uninstall the SODA app, simply delete it from your
    ...
    <div v-if="current_os === 'linux' || current_os === 'all'">
      ...
      <ul class="docs-ul list-outside list-decimal">
        ...
        <li>
          Double click the downloaded SODA app icon and it should open the app.
        </li>
        <li>
          To stop the application click on the red circle/button in the top left
          corner.
        </li>
      </ul>
      ...
      <div class="p-parent-div">
        <p>
          Since our Linux SODA app is in the AppImage format, you can move this
          file anywhere on your computer and run it. If you would like to move
          the app into the applications folder, we recommend you use the
          open-source
          <a
            href="https://app.pennsieve.net/"
            target="_blank"
