  ...
  <div class="flex flex-col">
    ...
    <div class="p-parent-div">
      <p>
        ...
        from your dataset on Pennsieve, NCBI Taxonomy, Scicrunch, and
        protocols.io to help you populate some of the fields easily. The
        expected structure of this file, generated automatically by SODA, is
        explained in our corresponding "How to" page if you would like to learn
        about it.
      </p>
    </div>
      ...
      <li>
        ...
        <ul class="docs-ul list-outside list-disc">
          <li>
            ...
            folder inside primary. E.g: pool 1.
          </li>
          <li>
      ...
      <li>
        ...
        <ul class="docs-ul list-outside list-disc">
          ...
          <li>
            ...
            the NCBI taxonomy. E.g: Rattus
          </li>
          <li>
            Strain: This is the organism strain of the subject. When users start
          ...
          <li>
            ...
            your convenience, SODA separates this entry into 2 fields: A number
            field (e.g: 1, 2, 3) and a unit field (e.g: hours, days, weeks,
            etc). If an ISO format is expected for this entry, enter the
            ISO-formatted text in the number field, and select "N/A" for the
            unit field.
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul class="docs-ul list-outside list-disc">
          ...
          <li>
            ...
            maximum age (oldest) of the research subjects. The format for these
            2 fields is numerical value + space + unit (spelled out).
          </li>
        </ul>
      </li>
      <li>
        ...
        <ul class="docs-ul list-outside list-disc">
          <li>
            ...
            is uploaded to Protocols.io. In SODA, users can connect to their
      ...
      <li>
        ...
        <ul class="docs-ul list-outside list-disc">
          ...
          <li>
            ...
            modified alleles in transgenic animals belonging to the same subject
            group. Note: Ignore this field if the RRID is already provided.
          </li>
          <li>
    ...
    <ul class="docs-ul list-outside list-disc">
      ...
      <li>
        In the sample table, click on the "pen" symbol next to a sample to edit
        information about an existing sample.
      </li>
      <li>
