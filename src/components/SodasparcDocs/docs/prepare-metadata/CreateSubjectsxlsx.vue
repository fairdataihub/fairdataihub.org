  ...
  <div class="flex flex-col">
    ...
    <div class="p-parent-div">
      <p>
        ...
        provides a convenient interface, which is more intuitive than the Excel
    ...
    <ul class="docs-ul list-outside list-disc">
      <li>
        ...
        enter Step 2. SODA will extract the subject ID(s) (if available) onto
        the table of samples for your edits.
      </li>
      <li>
      ...
      <li>
        ...
        subject, you have the option to do that by clicking "Add a subject", and
        specify an existing subject to copy information from.
      </li>
    </ul>
  </div>
</template>
