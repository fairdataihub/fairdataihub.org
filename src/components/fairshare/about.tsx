    ...
    <div className="mx-auto max-w-screen-lg px-6 sm:px-6 lg:px-8">
      <div className="lg:text-center">
        ...
        <p className="max-w-2xl font-asap text-xl text-black sm:text-xl lg:mx-auto">
          ...
          to easily organize and share their COVID-19 and other infectious
          diseases related genomics, immunology, research software and other
          ...
          <div className="relative">
            ...
            <dd className="mt-2 ml-16 font-asap text-lg text-black sm:text-base md:mt-0">
              <div>
                ...
                COVID-19 and other infectious diseases research data according
                to applicable FAIR guidelines.
              </div>
            </dd>
          </div>
        </dl>
