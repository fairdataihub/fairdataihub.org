    ...
    <div className="mx-auto max-w-screen-lg px-6 sm:px-6 lg:px-8">
      <div className="lg:text-center">
        ...
        <p className="max-w-2xl font-asap text-xl text-black sm:text-xl lg:mx-auto">
          ...
          to easily organize and share their biomedical data and software according to applicable FAIR guidelines.
        </p>
      </div>
      ...
      <div className="mt-10">
        <dl className="space-y-10 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10 md:space-y-0">
          ...
          <div className="relative">
            ...
            <dd className="mt-2 ml-16 font-asap text-lg text-black sm:text-base md:mt-0">
              <div>
                FAIRshare is a desktop software that streamlines the process of making biomedical research data 
                and software FAIR by combining intuitive user interface and automation.
              </div>
            </dd>
          </div>
        </dl>
