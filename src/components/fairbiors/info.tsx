              ...
              <div className="flex w-full flex-col justify-between sm:flex-row">
                <div className="mb-10 pr-10 sm:mb-5">
                  ...
                  <div className="mt-3 flex text-accent">
                    <a
                      href="https://github.com/FAIR-BioRS/Guidelines/graphs/contributors"
                      target="_blank"
                      className="mr-2"
                    ...
                    >
                      ...
                      <img
                        src="https://img.shields.io/github/contributors/FAIR-BioRS/Guidelines.svg?style=flat-square"
                        alt="fairshare contributors"
                      />
                    </a>
                    <a
                      href="https://github.com/FAIR-BioRS/Guidelines/stargazers"
                      target="_blank"
                      className="mr-2"
                      data-umami-event="Badge"
                      data-umami-event-project="FAIRshare"
                    ...
                    >
                      {/*  eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src="https://img.shields.io/github/stars/FAIR-BioRS/Guidelines.svg?style=flat-square"
                        alt="fairshare stars"
                      />
                    </a>
                    <a
                      href="https://github.com/FAIR-BioRS/Guidelines/issues"
                      target="_blank"
                      className="mr-2"
                      data-umami-event="Badge"
                      data-umami-event-project="FAIRshare"
                    ...
                    >
                      {/*  eslint-disable-next-line @next/next/no-img-element */}
                      <img
                        src="https://img.shields.io/github/issues/FAIR-BioRS/Guidelines.svg?style=flat-square"
