  ...
  return (
    ...
    >
      ...
      <div className="flex w-full flex-col px-0 py-3 sm:px-8 sm:py-4 md:w-1/2 lg:ml-2 lg:w-3/5">
        ...
        <h2 className="text-primary pb-1 text-xl font-medium sm:text-lg lg:text-2xl">
          {profile.title}
        </h2>
        ...
        {profile.education.length > 0 && (
          <div className="py-2">
            <h3 className="sm:text-md text-primary pb-1 text-lg font-medium lg:text-xl">
              Education
            </h3>
            <ul>
          ...
          {profile.twitter.show && (
            ...
            >
              <svg
                ...
                height="30"
                fill="currentColor"
                className="hover:text-accent h-9 w-9 text-xl text-gray-700 transition-colors duration-200 sm:h-6 lg:h-6 lg:w-6"
