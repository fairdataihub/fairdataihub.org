      ...
      <div class="mb-3 print:my-1">
        <h2
          class="
            ...
            dark:text-white
            mb-2
            print:my-0 print:text-sm print:dark:text-black
          "
        >
          Preliminary steps (only required once)
        </h2>
        <div class="flex flex-col">
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              <input
                type="checkbox"
              ...
              <div class="ml-3">
                <span class="span-content">
                  <span
                    ...
                    "
                  >
                    Open SODA and watch our quick video located under the
                    Overview tab to familiarize yourself with the user interface
                    of SODA.
                  </span>
                </span>
              </div>
            ...
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content print:text-sm print:dark:text-black">
                  <router-link
                    to="/sodaforsparc/docs/Create-a-new-dataset"
                    class="
                      hover:underline
                      text-blue-600
                      dark:text-blue-400
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content print:text-sm print:dark:text-black">
                  <router-link
                    to="/sodaforsparc/docs/Make-PI-owner-of-dataset"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content print:text-sm print:dark:text-black">
                  <router-link
                    to="/sodaforsparc/docs/Add-edit-subtitle"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content print:text-sm print:dark:text-black">
                  <router-link
                    to="/sodaforsparc/docs/Add-edit-description"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content print:text-sm print:dark:text-black">
                  <router-link
                    to="/sodaforsparc/docs/Upload-a-banner-image"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content print:text-sm print:dark:text-black">
                  <router-link
                    to="/sodaforsparc/docs/Assign-a-license"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content">
                  <router-link
                    to="/sodaforsparc/docs/Create-dataset_description-xlsx"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content">
                  <router-link
                    to="/sodaforsparc/docs/Share-with-curation-team"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
                  ...
                  <span
                    ...
                    "
                  >
                    (it is highly suggested to not make any changes after this
                    step until you are contacted by the Curation Team)
                  </span>
                </span>
              </div>
            </label>
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content">
                  <router-link
                    to="/sodaforsparc/docs/Share-with-SPARC-Consortium"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
          ...
          <div class="print:py-0 print:my-0">
            <label class="flex print:py-0 print:my-0">
              ...
              <div class="ml-3">
                <span class="span-content">
                  <router-link
                    to="/sodaforsparc/docs/Submit-for-pre-publishing-review"
                    class="hover:underline text-blue-600 dark:text-blue-400"
                  >
                    <span
                      class="
