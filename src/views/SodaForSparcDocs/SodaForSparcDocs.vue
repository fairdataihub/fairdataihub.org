...
<script>
import SodaForSparcSidebar from "./SodaForSparcSidebar.vue";
import MobileSodaForSparcSidebar from "./MobileSodaForSparcSidebar.vue";

export default {
  components: { SodaForSparcSidebar, MobileSodaForSparcSidebar },
  name: "SodaForSparcDocs",
  data() {
    return {
      sidebarList: [
        {
