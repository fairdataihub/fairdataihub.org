          ...
          <div class="w-full flex flex-col sm:flex-row justify-between">
            <dd class="mb-10 sm:mb-5 pr-10">
              ...
              >
                ...
                SPARC Codeathon. The idea was to improve user query understandability
                and result display of the SPARC Portal search engine.
                AQUA received the fourth-place prize at the Codeathon.
              </p>
