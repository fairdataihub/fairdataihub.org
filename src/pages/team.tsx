...
const TEAM_JSON = [
  ...
  },
  {
    ...
    bio: `Paapa is originally from Ghana where he had his Pharmacy and Master's degree. He also holds a PhD degree in pharmacolgy and neuroscience from UNTHSC, Texas. He became a part of the team in 2024. His interest lies in pharmacometrics and computational pharmacology. In his leisure time, he watches soccer (REAL MADRID).`,
    ...
    education: [
      ...
      `M.Sc. Natural Products Pharmacology (Kwame Nkrumah University of Science and Technology, Kumasi, 2015)`,
    ],
    twitter: {
      show: false,
      link: `https://twitter.com`,
