...
const Codefair: React.FC<PublicationsItemList> = ({ publications }) => {
  return (
    <>
      ...
      <ProjectStatistics
        title="Impact of Codefair"
        subtitle="Snapshot of usage and adoption"
        metrics={[
          {
            value: 660,
            suffix: `+`,
            description: `Repositories managed`,
            id: `repoNum`,
          },
          {
            value: 35,
            suffix: `+`,
            description: `Individual users and organizations using Codefair`,
            id: `dataNum`,
          },
        ]}
      />
