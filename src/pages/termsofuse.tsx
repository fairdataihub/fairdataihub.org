...
export default function TermsOfUse() {
  return (
    <>
      <Seo
        templateTitle="Terms of Use"
        templateDescription="View the Terms of Use of fairdataihub.org"
      ...
      <section className="mx-auto flex max-w-screen-lg flex-col px-6 py-5 text-lg text-black sm:px-6 lg:px-8">
        ...
        <p className="content">
          ...
          Services. By accessing or using any part of the website, you agree to
        ...
        <p className="content">
          ...
          to use the Site at any time for any reason at our sole discretion,
          ...
          to access and use the Site will terminate immediately. You understand
          that any termination of your Account may involve deletion of your User
          Content associated with your Account from our live databases. Company
          will not have any liability whatsoever to you for any termination of
          your rights under these Terms. Even after your rights under these
          Terms are terminated, the following provisions of these Terms will
          remain in effect: Sections 2 through 2.5, Section 3 and Sections 4
          through 10.
        </p>
        ...
        <p className="content">
          ...
          contains procedures for MANDATORY BINDING ARBITRATION AND A className
          ACTION WAIVER.
        </p>
        ...
        <p className="content">
          ...
          and the Company, and to any subsidiaries, affiliates, agents,
        ...
        <p className="content">
          ...
          the Company should be sent to: 11107 Roselle St. Ste #211 San Diego,
          CA 92121. After the Notice is received, you and the Company may
        ...
        <p className="content">
          ...
          be initiated and/or demanded within the statute of limitations and
          within any deadline imposed under the AAA Rules for the pertinent
          claim.
        </p>
        ...
        <p className="content">
          ...
          className basis, and claims of more than one customer or user cannot
          be arbitrated or litigated jointly or consolidated with those of any
        ...
        <p className="content">
          ...
          law to be invalid or unenforceable by a court of competent
        ...
        <p className="content">
          ...
          the other party&apos;s patent, copyright, trademark or trade secrets
        ...
        <p className="content">
          ...
          obligation that such communications would satisfy if it were be in a
          hard copy writing.
        </p>
        ...
        <p className="content">
          ...
          in full force and effect. The failure of Fair Data Innovation Hub to
          enforce any right or provision of this Agreement will not be deemed a
          waiver of such right or provision. A waiver by either party of any
          ...
          breach thereof. Subject to prior written consent of Fair Data
          Innovation Hub, you may assign your rights under this Agreement to any
          party that consents to, and agrees to be bound by, its terms and
          conditions; Fair Data Innovation Hub may assign its rights under this
        ...
        <p className="content">
          ...
          about Fair Data Innovation Hub&apos;s Terms of Use.
        </p>
        ...
        <p className="content">
          <strong> Email: </strong>
          <a href="mailto:info@fairdataihub.org" className="text-url text-base">
