      ...
      <main>
        <section className="mx-auto flex max-w-screen-lg flex-col px-6 py-5 text-lg text-black sm:px-6 lg:px-8">
          ...
          <p className="content">
            ...
            is a copyrighted work belonging to Fair Data Innovations Hub.
          ...
          <p className="content">
            ...
            Services. By accessing or using any part of the website, you agree
            ...
            terms and conditions are considered an offer by Fair Data
            Innovations Hub, acceptance is expressly limited to these terms. The
            Services is available only to individuals who are at least 13 years
            old (16 years for individuals from EU).
          </p>

          <h2 className="heading">Access to the Site</h2>

          <h3 className="subheading">Subject to these Terms</h3>

          <p className="content">
            Company grants you a non-transferable, non-exclusive, revocable,
            limited license to access the Site solely for your own personal,
            noncommercial use.
          </p>

          <h3 className="subheading">Certain Restrictions</h3>
          ...
          <p className="content">
            ...
            Data Innovations Hub will not be held liable to you or any
          ...
          <h2 className="heading">Third-Party Links & Ads; Other Users</h2>

          <h3 className="subheading">Third-Party Links & Ads</h3>
          ...
          <h3 className="subheading">Other Users</h3>
          ...
          <h2 className="heading">Limitation on Liability</h2>
          ...
          <h3 className="subheading">Term and Termination</h3>
          ...
          <p className="content">
            ...
            following provisions of these Terms will remain in effect: Sections
            2 through 2.5, Section 3 and Sections 4 through 10.
          </p>

          <h2 className="heading">Copyright Policy.</h2>
          ...
          <h3 className="subheading">Applicability of Arbitration Agreement</h3>
          ...
          <p className="content">
            ...
            Notice to the Company should be sent to: 11107 Roselle St. Ste #211
            San Diego, CA 92121. After the Notice is received, you and the
            Company may attempt to resolve the claim or dispute informally. If
            you and the Company do not resolve the claim or dispute within
            thirty (30) days after the Notice is received, either party may
            begin an arbitration proceeding. The amount of any settlement offer
            made by any party may not be disclosed to the arbitrator until after
            the arbitrator has determined the amount of the award to which
            either party is entitled.
          </p>

          <h3 className="subheading">Arbitration Rules</h3>

          <p className="content">
            Arbitration shall be initiated through the American Arbitration
            Association, an established alternative dispute resolution provider
            ...
            all aspects of the arbitration except to the extent such rules are
            in conflict with the Terms. The AAA Consumer Arbitration Rules
            ...
            sought is Ten Thousand U.S. Dollars (US $10,000.00) or more, the
          ...
          <h3 className="subheading">Time Limits</h3>
          ...
          <h3 className="subheading">Authority of Arbitrator</h3>

          <p className="content">
            If arbitration is initiated, the arbitrator will decide the rights
            and liabilities of you and the Company, and the dispute will not be
          ...
          <h3 className="subheading">Waiver of Jury Trial</h3>
          ...
          <p className="content">
            ...
            are typically more limited, more efficient and less expensive than
            ...
            the Company in any state or federal court in a suit to vacate or
          ...
          <p className="content">
            ...
            not on a className basis, and claims of more than one customer or
            user cannot be arbitrated or litigated jointly or consolidated with
            those of any other customer or user.
          </p>

          <h3 className="subheading">Confidentiality</h3>
          ...
          <h3 className="subheading">Right to Waive</h3>
          ...
          <h3 className="subheading">Survival of Agreement</h3>
          ...
          <h3 className="subheading">Small Claims Court</h3>
          ...
          <h3 className="subheading">Emergency Equitable Relief</h3>
          ...
          <p className="content">
            ...
            status quo pending arbitration. A request for interim measures shall
            not be deemed a waiver of any other rights or obligations under this
            Arbitration Agreement.
          </p>

          <h3 className="subheading">Claims Not Subject to Arbitration</h3>
          ...
          <h3 className="subheading">Electronic Communications</h3>
          ...
          <h3 className="subheading">Entire Terms</h3>
          ...
          <p className="content">
            ...
            limitation&quot;. If any provision of these Terms is held to be
          ...
          <h3 className="subheading">Miscellaneous</h3>
          ...
          <p className="content">
            ...
            amendment signed by an authorized executive of Fair Data Innovation
            Hub, or by the posting by Fair Data Innovation Hub of a revised
            version. If any part of this Agreement is held invalid or
            unenforceable, that part will be construed to reflect the
            parties&apos; original intent, and the remaining portions will
            remain in full force and effect. The failure of Fair Data Innovation
            Hub to enforce any right or provision of this Agreement will not be
            deemed a waiver of such right or provision. A waiver by either party
            of any term or condition of this Agreement or any breach thereof, in
            any one instance, will not waive such term or condition or any
            subsequent breach thereof. Subject to prior written consent of Fair
            Data Innovation Hub, you may assign your rights under this Agreement
            to any party that consents to, and agrees to be bound by, its terms
            and conditions; Fair Data Innovation Hub may assign its rights under
          ...
          <h3 className="subheading">Copyright/Trademark Information</h3>
          ...
          <h2 className="subheading">Questions and complaints</h2>

          <p className="content">
            Please feel free to contact us if you have any questions or
            complaints about Fair Data Innovation Hub&apos;s Terms of Use.
          </p>
          ...
          <p className="content">
            <strong> Email: </strong>
            <a
              href="mailto:info@fairdataihub.org"
