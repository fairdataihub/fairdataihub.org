      ...
      <section className="mx-auto flex max-w-screen-lg flex-col px-6 py-5 text-lg text-black sm:px-6 lg:px-8">
        ...
        <div className="pl-8">
          <ul className="my-1 list-outside list-disc pb-3 text-base leading-7 text-gray-800">
            ...
            <li>
              <span className="italic"> The right to rectification </span> – You
            ...
            <li>
              <span className="italic"> The right to erasure </span> – You have
        ...
        <p className="content">
          ...
          will have an impact on you (e.g. when we start processing your
          personal information for other purposes than set out above), we will
          contact you prior to commencing that processing.
        </p>
